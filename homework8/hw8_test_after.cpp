...
int main(int argc, char *argv[])
{
	...
	TemplateTest();
	outfile << "TemplateTest() complete!" << std::endl
			<< std::endl;

	SmallTreeCopyTest();
	outfile << "SmallTreeCopyTest() complete!" << std::endl
			<< std::endl;

	EmptyTreeTest(outfile);
	outfile << "EmptyTreeTest() complete!" << std::endl
			<< std::endl;

	RealTreeTestNoPrint();
	outfile << "RealTreeTestNoPrint() complete!" << std::endl
			<< std::endl;
