...
void StudentTest(){
	...
	//subtraction
	std::cout << "Subtracting m5 and m6" << std::endl;
	std::cout << m5 << m6 << std::endl;
	...
	///testing the multiplying function
	std::cout << "Before muliplying" << std::endl;
	std::cout<<m7<<std::endl;
	m7.multiply_by_coefficient(3);
	std::cout << "After muliplying" << std::endl;
	std::cout<<m7<<std::endl;
